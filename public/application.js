...
var menuItems = __webpack_require__(10);
var userMenuItems = __webpack_require__(27);
var editItem = __webpack_require__(28);
var viewAllUsers = __webpack_require__(29);
var editUser = __webpack_require__(30);
...
var showAdminHomeScreen = function showAdminHomeScreen() {
  clearView();
  $('#navbar').show();
};

var showUserHomeScreen = function showUserHomeScreen() {
  clearView();
  $('#usr-navbar').show();
};
...
var onSignInSuccess = function onSignInSuccess() {
...
var displayMenuItems = function displayMenuItems() {
  if (store.user.isadmin === true) {
    var menuItemsHtml = menuItems({ items: store.menuItems.items });
    clearView();
    ...
    var userMenuItemsHtml = userMenuItems({ items: store.menuItems.items });
    clearView();
    $('#form-menuitemedit').empty();
    $('#menu-itemview').show();
    $('#menu-itemview').empty();
...
var displayMenuItemsFailure = function displayMenuItemsFailure() {
  $('#modal-notification').modal('toggle');
  $('.modal-title').text('Oops!');
  $('.modal-body').text('There was an error trying to view your items.  Please try again');
};

var editItemForm = function editItemForm() {
  $('#form-menuitemedit').empty();
  var editItemFormHtml = editItem({ item: store.oneItem });
...
var onEditItemSuccess = function onEditItemSuccess() {
  clearView();
  $('#modal-notification').modal('toggle');
  $('.modal-title').text('Success!');
...
var onEditItemFailure = function onEditItemFailure() {
  $('#modal-notification').modal('toggle');
  $('.modal-title').text('Oops!');
  $('.modal-body').text('You can\'t modify this item as it was created by another admin.');
};

var showMenuCreateItemForm = function showMenuCreateItemForm() {
  clearView();
  $('#form-menuitemcreate').show();
};

var onCreateMenuItemSuccess = function onCreateMenuItemSuccess() {
...
var onCreateMenuItemFailure = function onCreateMenuItemFailure() {
  // clearView()
  $('#modal-notification').modal('toggle');
  $('.modal-title').text('Oops!');
...
var onDeleteItemSuccess = function onDeleteItemSuccess() {
  clearView();
  $('#modal-notification').modal('toggle');
  $('.modal-title').text('Success!');
...
var displayAllUsers = function displayAllUsers() {
  if (store.user.isadmin === true) {
    var allUsersHtml = viewAllUsers({ users: store.allUsers });
    clearView();
    $('#users-viewall').empty();
    $('#users-viewall').show();
...
var displayAllUsersFailure = function displayAllUsersFailure() {
  $('#modal-notification').modal('toggle');
  $('.modal-title').text('Oops!');
  $('.modal-body').text('There was an error.  Please try again.');
};

var userEditForm = function userEditForm() {
  $('#form-useredit').empty();
  var userEditFormHtml = editUser({ item: store.oneUser });
  // $('#form-menuitemcreate').hide()
  clearView();
  // $('#menu-itemview').empty()
...
var onUpdateUserSuccess = function onUpdateUserSuccess() {
  clearView();
  $('#modal-notification').modal('toggle');
  $('.modal-title').text('Success!');
...
var onUpdateUserFailure = function onUpdateUserFailure() {
  clearView();
  $('#modal-notification').modal('toggle');
  $('.modal-title').text('Ooops!');
...
var orderStatusUpdate = function orderStatusUpdate() {
...
module.exports = {
  ...
  showAdminHomeScreen: showAdminHomeScreen,
  showUserHomeScreen: showUserHomeScreen,
  ...
  displayMenuItemsFailure: displayMenuItemsFailure,
  showMenuCreateItemForm: showMenuCreateItemForm,
  editItemForm: editItemForm,
  onEditItemSuccess: onEditItemSuccess,
  onEditItemFailure: onEditItemFailure,
  onCreateMenuItemSuccess: onCreateMenuItemSuccess,
  onCreateMenuItemFailure: onCreateMenuItemFailure,
  onDeleteItemSuccess: onDeleteItemSuccess,
  onDeleteItemFailure: onDeleteItemFailure,
  displayAllUsers: displayAllUsers,
  displayAllUsersFailure: displayAllUsersFailure,
  userEditForm: userEditForm,
  onUpdateUserSuccess: onUpdateUserSuccess,
  onUpdateUserFailure: onUpdateUserFailure,
...
$(function () {
  ...
  $('#navbar-createuser').on('click', events.createUser);
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "        <td><button id=\""
    ...
    + "-edt\" class=\"btn btn-primary edit\">Edit</button></td>\n        <td><button id=\""
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.id : stack1), depth0))
    + "-del\" class=\"btn btn-danger delete\">Delete</button></td>\n";
},"4":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "          <td><p>Unavailable. Record owned by user id #"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.user_id : stack1), depth0))
    + ".</p></td>\n          <td><p>Unavailable. Record owned by user id #"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1.user_id : stack1), depth0))
    + ".</p></td>\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <tr>\n      <td>"
    ...
    + "</td>\n      <td><button id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "-order\" class=\"btn btn-primary order\"> Order </button></td>\n    </tr>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<!-- Menu items edit start -->\n<!-- <div class=\"row\" id=\"form-menuitemedit\"> -->\n<div class=\"col-xs-12 col-md-3\"></div>\n<div class=\"app-title col-xs-12 col-md-6\">\n  <h3>Edit Menu Item</h3>\n  <form id=\"btn-menuitemedit-submit\">\n    <div class=\"form-group\">\n      <label for=\"itemName\">Item Name</label>\n      <textarea id=\"edit-itemname\" name=\"item[name]\" type=\"text\" class=\"form-control itemname\" placeholder=\"Name to display on menu\"></textarea>\n      <label for=\"itemDescription\">Item Description</label>\n      <textarea id=\"edit-itemdescr\" name=\"item[description]\" type=\"text\" class=\"form-control\" placeholder=\"Describe the item\"></textarea>\n      <label for=\"itemPrice\">Item Price</label>\n      <input id=\"edit-itemprice\" name=\"item[price]\" type=\"number\" step=\".01\" class=\"form-control\" placeholder=\"0.00\">\n      <label for=\"itemCategory\">Item Category</label>\n      <input id=\"edit-itemcategory\" name=\"item[category]\" type=\"text\" class=\"form-control\" value="
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.item : depth0)) != null ? stack1.category : stack1), depth0))
    + " placeholder=\"Entree, appetizer, etc.\">\n      <button type=\"submit\" class=\"btn btn-primary\"> Update </button>\n      <!-- <button type=\"submit\" class=\"btn btn-primary\"> Cancel </button> -->\n    </div>\n  </form>\n</div>\n<div class=\"col-xs-12 col-md-3\"></div>\n<!-- Menu items edit ends -->\n";
},"useData":true});
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <tr>\n      <td>"
    ...
    + "</td>\n      <td>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.isadmin : stack1), depth0))
    + "</td>\n      <td><button id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "-usredt\" class=\"btn btn-primary edit\">Edit</button></td>\n      <td><button id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "-usrdel\" class=\"btn btn-danger delete\">Delete</button></td>\n    </tr>\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<!-- User edit start -->\n<!-- <div class=\"row\" id=\"form-menuitemedit\"> -->\n<div class=\"col-xs-12 col-md-3\"></div>\n<div class=\"app-title col-xs-12 col-md-6\">\n  <h3>Edit User</h3>\n  <form id=\"btn-useredit-submit\">\n    <div class=\"form-group\">\n      <label for=\"userEmail\"> Email Address </label>\n      <input id=\"edit-useremail\" name=\"user[email]\" type=\"email\" class=\"form-control itemname\" placeholder=\"user@place.com\">\n      <label for=\"adminStatus\"> Admin Status </label>\n      <!-- <input id=\"edit-userisadmin\" name=\"user[isadmin]\" type=\"text\" class=\"form-control\" placeholder=\"true or false\"> -->\n      <select id=\"edit-userisadmin\" name=\"user[isadmin]\" class=\"form-control\">\n        <option value=\"false\">False</option>\n        <option value=\"true\">True</option>\n      </select>\n      <button type=\"submit\" class=\"btn btn-primary\"> Update </button>\n      <!-- <button type=\"submit\" class=\"btn btn-primary\"> Cancel </button> -->\n    </div>\n  </form>\n</div>\n<div class=\"col-xs-12 col-md-3\"></div>\n<!-- User edit ends -->\n";
},"useData":true});
...
var signUp = function signUp(event) {
  ...
  api.signUp(userForm).then(ui.onSignUpSuccess).catch(ui.onSignUpFailure);
};

var signIn = function signIn() {
  event.preventDefault();
  var userForm = getFormFields(this);
  api.signIn(userForm).then(ui.onSignInSuccess).catch(ui.onSignInFailure);
};

var changePassword = function changePassword() {
  event.preventDefault();
  var userForm = getFormFields(this);
  api.changePassword(userForm).then(ui.onChangePasswordSuccess).catch(ui.onChangePasswordFailure);
};
...
var getMenuItems = function getMenuItems() {
  event.preventDefault();
  // $('#form-menuitemcreate').hide()
  api.getMenuItems().then(ui.displayMenuItems).catch(ui.displayMenuItemsFailure);
};

var createMenuItem = function createMenuItem(event) {
  event.preventDefault();
  var userForm = getFormFields(this);
  api.createMenuItem(userForm).then(ui.onCreateMenuItemSuccess).catch(ui.onCreateMenuItemFailure);
};

var extractId = function extractId() {
  event.preventDefault();
  var element = this.id;
  ...
  store.btn = btn;
  if (btn === 'edt') {
    api.getMenuItem(store.item).then(ui.editItemForm).catch(ui.onEditItemFailure);
  } else if (btn === 'del') {
    ...
    store.id = item;
    api.getUserInfo(store.id).then(ui.userEditForm);
...
var deleteItemConfirmed = function deleteItemConfirmed() {
  event.preventDefault();
  //console.log('item is', store.item)
  //console.log('deleteItemConfirmed invoked')
  api.deleteItem().then(ui.onDeleteItemSuccess).catch(ui.onDeleteItemFailure);
};

var updateMenuItem = function updateMenuItem() {
  event.preventDefault();
  var userForm = getFormFields(this);
  api.updateMenuItem(userForm).then(ui.onEditItemSuccess).catch(ui.onEditItemFailure);
};
...
var viewUsers = function viewUsers() {
  event.preventDefault();
  api.getAllUsers().then(ui.displayAllUsers).catch(ui.displayAllUsersFailure);
};

var updateUser = function updateUser(event) {
  event.preventDefault();
  var userForm = getFormFields(this);
  api.updateUser(userForm).then(ui.onUpdateUserSuccess).catch(ui.onUpdateUserFailure);
};
...
var updateMenuItem = function updateMenuItem(data) {
  return $.ajax({
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://kaizenapi.herokuapp.com',
...
var addNestedValue = __webpack_require__(35);
...
module.exports = __webpack_require__.p + "092affe702d37ca6cd7555e9991913f7.jpg";
